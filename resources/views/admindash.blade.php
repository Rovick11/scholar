...
<body>
    ...
    <a href="{{ route('admin_userAppMan') }}" class="card">
        <i class="fas fa-hourglass-half"></i> Pending Applications <span>{{ $pendingCount }}</span>
    </a>
    <a href="{{ route('admin_reportAna') }}" class="card">
        <i class="fas fa-award"></i> Awarded Scholarships <span>{{ $awardedCount }}</span>
    </a>
    <a href="{{ route('admin_reportAna') }}" class="card">
        <i class="fas fa-users"></i> Total Users <span>{{ $totalUsers }}</span>
    </a>
</div>
